...
import {responseWithMetadata, responseWithMessage} from '../utils/response';
  ...
  static topUpBalanceForCurrentUser = [
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const response = await TransactionService.topUpBalanceByEmail({
          email: validatedRequest.email,
  ...
  static paymentForCurrentUser = [
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const response = await TransactionService.paymentByEmail({
          email: validatedRequest.email,
          transactionType: validatedRequest.transactionType,
