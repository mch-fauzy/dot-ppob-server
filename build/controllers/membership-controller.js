    ...
    static updateProfileForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const response = await membership_service_1.MembershipService.updateProfileByEmail({
                    email: validatedRequest.email,
                    firstName: validatedRequest.firstName,
                    lastName: validatedRequest.lastName,
                });
    ...
    static updateProfileImageForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const response = await membership_service_1.MembershipService.updateProfileImageByEmail({
                    email: validatedRequest.email,
    ...
    static updateProfileImageCloudinaryForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const response = await membership_service_1.MembershipService.updateProfileImageCloudinaryByEmail({
                    email: validatedRequest.email,
