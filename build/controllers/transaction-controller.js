    ...
    static topUpBalanceForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const response = await transaction_service_1.TransactionService.topUpBalanceByEmail({
                    email: validatedRequest.email,
    ...
    static paymentForCurrentUser = [
        ...
        async (req, res, next) => {
            try {
                ...
                const response = await transaction_service_1.TransactionService.paymentByEmail({
                    email: validatedRequest.email,
                    transactionType: validatedRequest.transactionType,
