...
membershipRouterV1.patch('/profile/update', membership_controller_1.MembershipController.updateProfileForCurrentUser);
// membershipRouterV1.put('/profile/image', MembershipController.updateProfileImageForCurrentUser);
membershipRouterV1.patch('/profile/image', membership_controller_1.MembershipController.updateProfileImageCloudinaryForCurrentUser);
